...
echo "   Required substitutions: _GCS_BUCKET _GCS_KEY_FILENAME _QDRANT_URL _AI_GATEWAY_URL _PRODUCTION_URL _CLOUDSQL_CONNECTION_NAME _DB_SOCKET_PATH _DB_NAME _DB_USER _VPC_CONNECTOR _VPC_EGRESS"
echo ""
