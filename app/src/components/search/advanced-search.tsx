...
export default function AdvancedSearch({ searchType, aiPowered, semanticSearch }: AdvancedSearchProps) {
  ...
  const mockResults: SearchResult[] = useMemo(() => [
    { id: '1', title: 'HORIZON-CL4-2024-DATA-01 — AI for Manufacturing', type: 'opportunity', description: 'Apel pentru proiecte de inteligență artificială aplicate în industria prelucrătoare', relevanceScore: 94, metadata: { Buget: '5M€', Deadline: '2026-04-15' } as Record<string, string>, highlights: ['<em>AI</em> aplicat în <em>manufacturing</em> cu focus pe sustenabilitate'], tags: ['AI', 'Industry 4.0', 'Horizon Europe'] },
    { id: '2', title: 'Fraunhofer-Gesellschaft', type: 'partner', description: 'Institut german de cercetare aplicată — lider european în AI și IoT', relevanceScore: 88, metadata: { Țara: 'DE', Tip: 'Cercetare', Proiecte: '45' } as Record<string, string>, highlights: [], tags: ['AI', 'IoT', 'Cercetare'] },
    { id: '3', title: 'SmartCity-RO: Orașe Inteligente România', type: 'project', description: 'Proiect POCIDIF pentru digitalizarea serviciilor publice din orașe românești', relevanceScore: 76, metadata: { Status: 'Activ', Buget: '2.1M€' } as Record<string, string>, highlights: ['Digitalizare servicii publice cu <em>AI</em>'], tags: ['Smart City', 'România', 'POCIDIF'] },
    { id: '4', title: 'Best Practices: Consortium Management in H2020', type: 'article', description: 'Ghid detaliat pentru managementul eficient al consorțiilor în programele cadru europene', relevanceScore: 71, metadata: { Autor: 'EC Guide', An: '2024' } as Record<string, string>, highlights: [], tags: ['Management', 'Best Practices', 'Consorțiu'] },
  ], []);
