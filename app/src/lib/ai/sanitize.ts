...
const SECRET_ASSIGNMENT_PATTERN = /\b(?:OPENAI_API_KEY|ANTHROPIC_API_KEY|GOOGLE_AI_API_KEY|NEXTAUTH_SECRET|STRIPE_SECRET_KEY|STRIPE_WEBHOOK_SECRET|QDRANT_API_KEY)\b\s*[:=]\s*[^\s"'`]+/gi;
