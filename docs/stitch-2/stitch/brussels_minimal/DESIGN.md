...
*   **Gradients:** Use mesh gradients (transitioning from `primary` `#0071e3` to `secondary` `#4a47d2`) only for high-impact CTAs or as soft "halos" behind glass cards to indicate AI activity.
...
### Buttons
*   **Primary:** Solid `primary_container` (`#0071e3`). Border-radius `md` (1.5rem) or `lg` (2rem). No shadow. 
